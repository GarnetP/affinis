...
#SBATCH --job-name=TEtrimmer_earlgreylib
...
#SBATCH --error=TEtrimmerEGL.err
#SBATCH --output=TEtrimmerEGL.out
...
TEtrimmer --input_file /pub/gphinney/myrepos/affinis/data/processed/earlgreyoutput/drosophilaAffinis_combined_library.fasta \
          ...
          --output_dir /pub/gphinney/myrepos/affinis/output/TEtrimmer_output/EGLrun \
          --num_threads 20 \
          --classify_all
